/* Generated By:JJTree: Do not edit this line. DecimalLit.java */
...
public class DecimalLit extends SimpleNode {
  public DecimalLit(int id) {
    super(id);
  }

  public DecimalLit(XQueryParser p, int id) {
    super(p, id);
  }
