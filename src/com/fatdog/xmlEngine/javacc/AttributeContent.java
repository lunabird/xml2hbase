/* Generated By:JJTree: Do not edit this line. AttributeContent.java */
...
public class AttributeContent extends SimpleNode {
  public AttributeContent(int id) {
    super(id);
  }

  public AttributeContent(XQueryParser p, int id) {
    super(p, id);
  }
