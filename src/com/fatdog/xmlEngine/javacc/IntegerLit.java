/* Generated By:JJTree: Do not edit this line. IntegerLit.java */
...
public class IntegerLit extends SimpleNode {
  public IntegerLit(int id) {
    super(id);
  }

  public IntegerLit(XQueryParser p, int id) {
    super(p, id);
  }
