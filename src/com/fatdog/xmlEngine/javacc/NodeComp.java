/* Generated By:JJTree: Do not edit this line. NodeComp.java */
...
public class NodeComp extends SimpleNode {
  public NodeComp(int id) {
    super(id);
  }

  public NodeComp(XQueryParser p, int id) {
    super(p, id);
  }
