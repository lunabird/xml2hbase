/* Generated By:JJTree: Do not edit this line. OrderComp.java */
...
public class OrderComp extends SimpleNode {
  public OrderComp(int id) {
    super(id);
  }

  public OrderComp(XQueryParser p, int id) {
    super(p, id);
  }
