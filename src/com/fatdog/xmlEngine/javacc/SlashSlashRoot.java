/* Generated By:JJTree: Do not edit this line. SlashSlashRoot.java */
...
public class SlashSlashRoot extends SimpleNode {
  public SlashSlashRoot(int id) {
    super(id);
  }

  public SlashSlashRoot(XQueryParser p, int id) {
    super(p, id);
  }
