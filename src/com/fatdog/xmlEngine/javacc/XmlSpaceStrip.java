/* Generated By:JJTree: Do not edit this line. XmlSpaceStrip.java */
...
public class XmlSpaceStrip extends SimpleNode {
  public XmlSpaceStrip(int id) {
    super(id);
  }

  public XmlSpaceStrip(XQueryParser p, int id) {
    super(p, id);
  }
