/* Generated By:JJTree: Do not edit this line. EnclosedExpr.java */
...
public class EnclosedExpr extends SimpleNode {
  public EnclosedExpr(int id) {
    super(id);
  }

  public EnclosedExpr(XQueryParser p, int id) {
    super(p, id);
  }
