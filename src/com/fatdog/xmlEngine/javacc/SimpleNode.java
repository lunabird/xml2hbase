...
public class SimpleNode implements Node {
  ...
  public void setText( String image )   { m_text = image; }
  //---------------------------------
  ...
  //changed 2feb02 to possibly return null
  ...
  /* Override this method if you want to customize how the node dumps
	...
	//-----------------------------
	{
	  ...
	  System.out.println( m_text == null ?	"" : 
											  " [ " + m_text + " ]" );      
	  if (children != null) {
	...
	public void setHasContext( boolean hasContext ) 	{ m_hasContext = hasContext; }
	//---------------------------------------------
	public boolean getHasContext()						{ return m_hasContext; }
	//----------------------------
}
/*
