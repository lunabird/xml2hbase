/* Generated By:JJTree: Do not edit this line. StringLit.java */
...
public class StringLit extends SimpleNode {
  public StringLit(int id) {
    super(id);
  }

  public StringLit(XQueryParser p, int id) {
    super(p, id);
  }
