/* Generated By:JJTree: Do not edit this line. ValueComp.java */
...
public class ValueComp extends SimpleNode {
  public ValueComp(int id) {
    super(id);
  }

  public ValueComp(XQueryParser p, int id) {
    super(p, id);
  }
