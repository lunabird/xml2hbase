/* Generated By:JJTree: Do not edit this line. RelPath.java */
...
public class RelPath extends SimpleNode {
  public RelPath(int id) {
    super(id);
  }

  public RelPath(XQueryParser p, int id) {
    super(p, id);
  }
