/* Generated By:JJTree: Do not edit this line. GeneralComp.java */
...
public class GeneralComp extends SimpleNode {
  public GeneralComp(int id) {
    super(id);
  }

  public GeneralComp(XQueryParser p, int id) {
    super(p, id);
  }
