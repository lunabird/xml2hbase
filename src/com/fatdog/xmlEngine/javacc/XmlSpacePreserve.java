/* Generated By:JJTree: Do not edit this line. XmlSpacePreserve.java */
...
public class XmlSpacePreserve extends SimpleNode {
  public XmlSpacePreserve(int id) {
    super(id);
  }

  public XmlSpacePreserve(XQueryParser p, int id) {
    super(p, id);
  }
