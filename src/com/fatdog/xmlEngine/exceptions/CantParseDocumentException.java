...
package com.fatdog.xmlEngine.exceptions;
	...
	/**
	 * The engine has encountered a non-parseable XML file. Generally (always?)
	 * rethrown in place of a SAXException or SAXParseException.
	 * 
	 * @author Howard Katz, howardk@fatdog.com
	 * @version 0.69
	 */

public class CantParseDocumentException extends Exception
{
    public CantParseDocumentException( String msg )
    //---------------------------------------------
    {
        super( msg );
    }
