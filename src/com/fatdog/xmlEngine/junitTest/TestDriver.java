...
public class TestDriver extends TestCase
{
	...
	//------------------------
	{
		...
		suite.addTest( Arithmetic.suite() );
		
  		suite.addTest( Constructors.suite() );
		suite.addTest( Expressions.suite() );
		suite.addTest( Functions.suite() );

		suite.addTest( OneFileXPaths.suite() );	
		suite.addTest( TwoFileXPaths.suite());
		
		suite.addTest( ProtocolHandlerTest.suite() );
		suite.addTest( XQueryUseCases.suite() );

		suite.addTest( Namespaces.suite() );
