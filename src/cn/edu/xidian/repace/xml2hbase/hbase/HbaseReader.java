...
public class HbaseReader {
    ...
    //閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熷彨鍏崇》鎷烽敓鏂ゆ嫹,閿熸枻鎷峰彇涓�敓鍙》鎷峰綍
	 ...
	 //閿熸枻鎷烽敓鎻紮鎷峰睉閿熼摪纭锋嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸彮浼欐嫹閿熺纯baseInfor閿熸枻鎷烽敓鏂ゆ嫹閿熻妭纰夋嫹閿熸枻鎷烽敓鏂ゆ嫹鏃堕敓鏂ゆ嫹閿熸枻鎷峰閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹娉勪付閿熸枻鎷烽敓锟�
	   public static void getOneRecord (HbaseInfor object,List<String> qualifierlist,List<String> valuelist) throws IOException
	   {
		...
		public static Result  getRowWithEqualFilter(String tableName,String rowKey, FilterList filters) throws IOException
	     { 
	    	 String value = null;
	    	 Result rs = null;
	    	 if (!tableName.equals(""))
	   		  ...
	   		  if (!rowKey.equals(""))
	   		  	{ 
	   					  try
	   					  {
	   						  ...
	   						  rs=table.get(get);
	   						  //byte[] val=rs.getValue(Bytes.toBytes(column), Bytes.toBytes(qualifier));				  
	   						  //value = Bytes.toString(val);
		...
		//閿熸枻鎷烽敓鏂ゆ嫹HbaseInfor閿熸枻鎷烽敓鏂ゆ嫹閿熺殕纭锋嫹鍊奸敓鏂ゆ嫹閿熶粙锛涢敓鑺傜鎷烽敓鐭尨鎷烽敓鏂ゆ嫹涔嬪墠閿熸枻鎷峰閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鍙叧纭锋嫹閿熻锝忔嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓楗衡埀楠嬩紮鎷烽敓渚ラ獘浼欐嫹閿熸枻鎷锋閿熸枻鎷烽敓鏂ゆ嫹
